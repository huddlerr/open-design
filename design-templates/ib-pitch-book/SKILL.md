...
repackaged as an Design Jury `deck` skill.
...
Follow Design Jury's deck export path for the active session (HTML / PDF /
PPTX per daemon capabilities).

## Relationship to Design Jury financial skills
...
original adaptation for Design Jury.
