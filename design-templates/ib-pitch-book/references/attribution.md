...
The Design Jury skill bundle (`SKILL.md`, `example.html`, `assets/template.html`,
and references in this folder) is contributed under Design Jury's repository
