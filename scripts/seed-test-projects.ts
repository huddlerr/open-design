#!/usr/bin/env node
// Seed Design Jury with pre-baked test projects so the UI has real slide
...
Seeds Design Jury with pre-baked, real HTML artifacts from:
  - Skills examples
