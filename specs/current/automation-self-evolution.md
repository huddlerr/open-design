...
Automations should become the product-wide loop that lets Design Jury improve
...
Design Jury becomes a self-evolving design agent when every useful run can
