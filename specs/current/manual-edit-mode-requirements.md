# Design Jury Manual Edit Mode Requirements

## Purpose

This document records the accepted manual edit-mode model from `apps/edit-mode-demo` so it can be migrated into the main Design Jury web app.
...
- Preserve Design Jury's existing preview model.
...
- Design Jury-specific mode rail:
  - Preview
  - Edit
  - Comment AI
  - Tweaks
...
Existing Design Jury integration points:
