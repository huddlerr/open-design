...
Maintainer de `nexu-io/design-jury`. A composição individual do Core Team é
...
| **Core Team** | Time interno do Design Jury. Possui acesso total de escrita ao repositório e é a autoridade final em decisões de governança. Composição mantida internamente. |
...
- **≥ 20 merged PRs** em `nexu-io/design-jury`.
...
Enquanto `nexu-io/design-jury` tiver menos de seis meses desde o commit inicial,
