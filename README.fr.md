# Design Jury — l’alternative open source officielle à [Claude Design][cd]

> **Design Jury est l’alternative open source et local-first à [Claude Design][cd].** Déployable sur le web, BYOK à chaque couche : vos CLI de coding agents détectées automatiquement dans le `PATH` deviennent le design engine, piloté par les catalogues de **Skills** et de **Design Systems** du repo. Aucune CLI ? Le proxy BYOK multi-provider exécute la même boucle, sans spawn local.
...
>
> **Itération rapide sur `main`** — 0.8.0 est la prochaine phase d'Design Jury. Envoie une PR, balance une idée folle, signale un bug — ce que tu apportes, c'est ce que ce mouvement devient.
>
> → [**Lire l'annonce · télécharger l'installateur · rejoindre le mouvement**](https://github.com/nexu-io/design-jury/discussions/1727) · s'installe à côté de votre 0.7 actuel.

<p align="center">
  <img src="docs/assets/banner.png" alt="Design Jury : couverture éditoriale, design avec l’agent sur votre laptop" width="100%" />
</p>
...
<p align="center">
  <a href="https://design-jury.ai/"><img alt="Télécharger" src="https://img.shields.io/badge/t%C3%A9l%C3%A9charger-open--design.ai-ff6b35?style=flat-square" /></a>
...
| **Déployable sur** | Local (`pnpm tools-dev`) · couche web Vercel · application desktop Electron empaquetée pour macOS (Apple Silicon) et Windows (x64) — téléchargement sur [design-jury.ai](https://design-jury.ai/) ou la [dernière release](https://github.com/nexu-io/design-jury/releases) |
| **Licence** | Apache-2.0 |
...
Le moyen le plus rapide d'essayer Design Jury est l'application desktop préconstruite — pas de Node, pas de pnpm, pas de clone :

- **[design-jury.ai](https://design-jury.ai/)** — page de téléchargement officielle
- **[Releases GitHub](https://github.com/nexu-io/design-jury/releases)**
...
│   ├── sidecar-proto/             ← contrat du sidecar protocol Design Jury
...
[**`heygen-com/hyperframes`**](https://github.com/heygen-com/hyperframes) est le framework vidéo open source agent-native de HeyGen : vous, ou l’agent, écrivez HTML + CSS + GSAP, HyperFrames rend un MP4 déterministe via Chrome headless + FFmpeg. Design Jury le livre comme modèle vidéo de première classe (`hyperframes-html`) relié au dispatch daemon, plus le skill `skills/hyperframes/` qui enseigne à l’agent le contrat de timeline, les transitions de scènes, les patterns audio-réactifs, captions/TTS et les catalog blocks (`npx hyperframes add <slug>`).
...
- **Sidecar protocol + automation desktop.** Les processus daemon, web et desktop portent des stamps typés à cinq champs (`app · mode · namespace · ipc · source`) et exposent un canal JSON-RPC IPC sous `/tmp/design-jury/ipc/<namespace>/<app>.sock`.
...
| Axe | [Claude Design][cd] (Anthropic) | [Open CoDesign][ocod] | **Design Jury** |
|---|---|---|---|
...
- [x] Build Electron empaqueté depuis `apps/packaged/` — téléchargements macOS (Apple Silicon) et Windows (x64) sur [design-jury.ai](https://design-jury.ai/) et la [page des releases GitHub](https://github.com/nexu-io/design-jury/releases)
...
Si ce projet vous a économisé trente minutes, donnez-lui une ★. Les stars ne paient pas le loyer, mais elles indiquent au prochain designer, agent ou contributeur que cette expérience mérite son attention : [github.com/nexu-io/design-jury](https://github.com/nexu-io/design-jury).
...
Merci à toutes les personnes qui font avancer Design Jury : code, docs, retours, nouveaux Skills, nouveaux Design Systems ou issues bien ciblées. Chaque vraie contribution compte.

<a href="https://github.com/nexu-io/design-jury/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nexu-io/design-jury&cache_bust=2026-05-23" alt="Contributeurs Design Jury" />
</a>

Si vous avez livré votre première PR, bienvenue. Le label [`good-first-issue`/`help-wanted`](https://github.com/nexu-io/design-jury/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22%2C%22help+wanted%22) est le point d’entrée.

## Activité du dépôt

<picture>
  <img alt="Design Jury : métriques du dépôt" src="docs/assets/github-metrics.svg" />
</picture>
...
<a href="https://star-history.com/#nexu-io/design-jury&Date">
  <picture>
    ...
    <img alt="Historique des stars Design Jury" src="https://api.star-history.com/svg?repos=nexu-io/design-jury&type=Date&cache_bust=2026-05-23" />
  </picture>
</a>
