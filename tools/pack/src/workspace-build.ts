...
const BUILD_COMMANDS = [
  { args: ["--filter", "@design-jury/contracts", "build"] },
  { args: ["--filter", "@design-jury/registry-protocol", "build"] },
  { args: ["--filter", "@design-jury/sidecar-proto", "build"] },
  { args: ["--filter", "@design-jury/sidecar", "build"] },
  { args: ["--filter", "@design-jury/platform", "build"] },
  { args: ["--filter", "@design-jury/agui-adapter", "build"] },
  { args: ["--filter", "@design-jury/plugin-runtime", "build"] },
  { args: ["--filter", "@design-jury/daemon", "build"] },
  { args: ["--filter", "@design-jury/web", "build"], env: ["OD_WEB_OUTPUT_MODE"] },
  { args: ["--filter", "@design-jury/web", "build:sidecar"] },
  { args: ["--filter", "@design-jury/desktop", "build"] },
  { args: ["--filter", "@design-jury/packaged", "build"] },
] as const;
