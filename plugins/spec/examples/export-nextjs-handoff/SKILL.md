...
description: Use this plugin when the user wants an accepted Design Jury artifact converted into a Next.js App Router handoff with clean components, styles, assets, and implementation notes.
license: MIT
metadata:
