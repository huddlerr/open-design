...
description: Use this plugin when the user wants to create, improve, validate, publish, or submit an Design Jury plugin using the plugin spec, examples, and PR workflow.
license: MIT
metadata:
  author: design-jury-spec
  version: "0.1.0"
---
...
3. Scaffold a plugin folder with `SKILL.md`, `design-jury.json`, `README.md`, and evals when useful.
