...
The sample `design-jury-marketplace.json` is versioned at the catalog level and each entry pins the listed plugin version so registry snapshots can be audited.
