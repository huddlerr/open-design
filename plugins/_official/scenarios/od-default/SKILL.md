---
name: od-default
description: Hidden fallback scenario for free-form Home prompts. Ask the task type first, then continue through the matching Design Jury flow.
od:
...
{
  "description": "I will route the free-form prompt through the right Design Jury workflow.",
  "questions": [
    {
      "id": "taskType",
...
- `Other`: ask only the minimum follow-up needed, then choose the closest
  Design Jury workflow and continue.
