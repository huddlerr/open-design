...
description: |
  ...
  apps, dogfooding Design Jury previews, QA, bug hunts, or reviewing app
  quality. Prefer local Design Jury preview URLs unless the user explicitly
...
Use `agent-browser` for local Design Jury preview validation: inspect rendered
...
With the Design Jury preview at `http://127.0.0.1:17573/`, run:
...
Expected success: title `Design Jury`, current URL under `127.0.0.1:17573`,
visible Design Jury UI text in the snapshot, and a screenshot at
