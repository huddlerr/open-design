...
## Current Design Jury scope

Design Jury currently ships this entry as discovery metadata only. If this `SKILL.md`
...
If those upstream files are not installed, explain that Design Jury only has the
catalog entry for this skill and ask whether to continue with Design Jury's
