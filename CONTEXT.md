...
Design Jury is a local-first design workspace where projects contain generated design files and agent conversations. This glossary records domain language only, not implementation details.
...
**Active Project**:
The project the user most recently interacted with in the Design Jury UI and that MCP tools may use when no project is specified.
