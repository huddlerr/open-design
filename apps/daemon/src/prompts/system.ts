...
import { defaultCritiqueConfig, type CritiqueConfig } from '@design-jury/contracts/critique';
...
export function composeSystemPrompt({
  ...
  // `@design-jury/contracts`'s composer. The daemon hits this path for
