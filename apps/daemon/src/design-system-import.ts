...
import { extractComponentsManifest } from '@design-jury/contracts';
...
function renderUsageMd(name: string, scan: ProjectScan): string {
  ...
  return [
    `# ${name} Usage`,
    '',
    '> Auto-generated by Design Jury importer. Review and edit before treating it as a canonical brand guide.',
    '',
    '## Read Order',
    '',
