...
import type { DegradedReason, PanelEvent, PanelistRole } from '@design-jury/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION } from '@design-jury/contracts/critique';
