...
//
//   - Validates the manifest using @design-jury/plugin-runtime's validateSafe.
...
import { manifestSourceDigest, resolveContext, validateSafe, type RegistryView } from '@design-jury/plugin-runtime';
import type { InstalledPluginRecord, PluginManifest } from '@design-jury/contracts';
