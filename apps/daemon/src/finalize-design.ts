...
// tsconfig does not resolve the `@design-jury/contracts/api/chat` subpath
...
} from '@design-jury/contracts/api/finalize';
...
// canonical definitions live in @design-jury/contracts/api/finalize
