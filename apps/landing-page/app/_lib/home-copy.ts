...
const en: HomeCopy = {
  ...
  aboutCaptionCredit: '(Design Jury, MMXXVI)',
  ...
  testimonialQuotePre: '“Design Jury helped us turn vague',
...
const zhCN: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '“Design Jury 帮我们把模糊的',
...
const ja: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '「Design Jury は私たちの曖昧な',
...
const ko: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '"Design Jury 은 우리의 모호한',
...
const zhTW: Partial<HomeCopy> = {
  ...
  testimonialLabel: '合作者 · Nº 06',
  testimonialQuotePre: '「Design Jury 幫我們把模糊的',
  testimonialQuoteEm1: 'AI 想法',
...
const de: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '„Design Jury hat uns geholfen, vage',
...
const fr: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '« Design Jury nous a aidés à transformer de vagues',
...
const esES: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '«Design Jury nos ayudó a convertir',
...
const ptBR: Partial<HomeCopy> = {
  ...
  testimonialLabel: 'Colaboradores · Nº 06',
  testimonialQuotePre: '"O Design Jury nos ajudou a transformar',
