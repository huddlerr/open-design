...
> = {
  fr: homeFallbackCopy({
    railRight: 'Design Jury — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle Design Jury',
    officialLabel: 'Source officielle',
    officialItems: [
      { label: 'Site officiel', value: 'design-jury.ai' },
      { label: 'Code source', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Édité par Design Jury',
    ...
    testimonial: {
      ...
      quote: '« Design Jury a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
  ...
  ru: homeFallbackCopy({
    railRight: 'Design Jury — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник Design Jury',
    officialLabel: 'Официальный источник',
    officialItems: [
      { label: 'Официальный сайт', value: 'design-jury.ai' },
      { label: 'Исходный код', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«Design Jury помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
  ...
  es: homeFallbackCopy({
    railRight: 'Design Jury — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de Design Jury',
    officialLabel: 'Fuente oficial',
    officialItems: [
      { label: 'Sitio oficial', value: 'design-jury.ai' },
      { label: 'Código fuente', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Editado por Design Jury',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«Design Jury convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
  ...
  'pt-br': homeFallbackCopy({
    railRight: 'Design Jury — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do Design Jury',
    officialLabel: 'Fonte oficial',
    officialItems: [
      { label: 'Site oficial', value: 'design-jury.ai' },
      { label: 'Código-fonte', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (Design Jury, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“Design Jury transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
  ...
  it: homeFallbackCopy({
    railRight: 'Design Jury — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale Design Jury',
    officialLabel: 'Fonte ufficiale',
    officialItems: [
      { label: 'Sito ufficiale', value: 'design-jury.ai' },
      { label: 'Codice sorgente', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Redazione Design Jury',
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“Design Jury ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
  ...
  vi: homeFallbackCopy({
    railRight: 'Design Jury — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của Design Jury',
    officialLabel: 'Nguồn chính thức',
    officialItems: [
      { label: 'Trang chính thức', value: 'design-jury.ai' },
      { label: 'Mã nguồn', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi Design Jury',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“Design Jury biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
  ...
  pl: homeFallbackCopy({
    railRight: 'Design Jury — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło Design Jury',
    officialLabel: 'Oficjalne źródło',
    officialItems: [
      { label: 'Oficjalna strona', value: 'design-jury.ai' },
      { label: 'Kod źródłowy', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      quote: '„Design Jury zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
  ...
  id: homeFallbackCopy({
    railRight: 'Design Jury — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi Design Jury',
    officialLabel: 'Sumber resmi',
    officialItems: [
      { label: 'Situs resmi', value: 'design-jury.ai' },
      { label: 'Kode sumber', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Disunting Design Jury',
      label: 'Karya pilihan',
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“Design Jury mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
  ...
  nl: homeFallbackCopy({
    railRight: 'Design Jury — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van Design Jury Discord',
    ...
    heroLead: (skills, systems) =>
      `Design Jury is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van Design Jury',
    officialLabel: 'Officiële bron',
    officialItems: [
      { label: 'Officiële site', value: 'design-jury.ai' },
      { label: 'Broncode', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“Design Jury veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
  ...
  ar: homeFallbackCopy({
    railRight: 'Design Jury — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ Design Jury',
    officialLabel: 'المصدر الرسمي',
    officialItems: [
      { label: 'الموقع الرسمي', value: 'design-jury.ai' },
      { label: 'الكود المصدري', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل Design Jury أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    faqSection: {
      ...
      label: 'أسئلة Design Jury الشائعة',
  ...
  tr: homeFallbackCopy({
    railRight: 'Design Jury — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Design Jury Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `Design Jury, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'Design Jury resmi kaynağı',
    officialLabel: 'Resmi kaynak',
    officialItems: [
      { label: 'Resmi site', value: 'design-jury.ai' },
      { label: 'Kaynak kod', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Design Jury editörlüğü',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“Design Jury belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
  ...
  uk: homeFallbackCopy({
    railRight: 'Design Jury — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord Design Jury',
    ...
    heroLead: (skills, systems) =>
      `Design Jury — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело Design Jury',
    officialLabel: 'Офіційне джерело',
    officialItems: [
      { label: 'Офіційний сайт', value: 'design-jury.ai' },
      { label: 'Вихідний код', value: 'nexu-io/design-jury' },
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (Design Jury, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«Design Jury допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
