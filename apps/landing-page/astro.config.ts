...
//
// `design-jury.ai` is the live domain bound to the Cloudflare Pages
// project (`design-jury-landing`); the env override exists so preview
...
const site = process.env.OD_LANDING_SITE ?? 'https://design-jury.ai';
