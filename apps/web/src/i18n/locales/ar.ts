...
export const ar: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ Design Jury (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى Design Jury.',
  ...
  'settings.mcpServerHint': 'كشف Design Jury كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'entry.githubStarAria': 'منح Design Jury نجمة على GitHub',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل Design Jury ثم أعد المحاولة.',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع Design Jury - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع Design Jury - لا حاجة للتحميل.',
  ...
  'updater.availableBody': 'Design Jury {version} متوفر. سيتم تنزيله قبل فتح المثبت.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. يتم الآن إنهاء Design Jury لتتمكن من إكمال التحديث.',
  ...
  'updater.quitButton': 'إنهاء Design Jury',
  'updater.quitFailedBody': 'المثبت مفتوح، لكن تعذر إنهاء Design Jury. أغلق Design Jury قبل استبدال التطبيق.',
  'updater.quitFailedTitle': 'تعذر الإنهاء',
  'updater.quitting': 'جارٍ الإنهاء...',
  'updater.ready': 'التحديث جاهز',
  'updater.readyGeneric': 'إصدار جديد جاهز. سيتم إغلاق Design Jury وفتح المثبت.',
  'updater.readyVersion': 'Design Jury {version} جاهز. سيتم إغلاق Design Jury وفتح المثبت.',
