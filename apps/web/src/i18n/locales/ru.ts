...
export const ru: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Design Jury (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Design Jury.',
  ...
  'settings.mcpServerHint': 'Откройте Design Jury как MCP-сервер для вашего кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставить Design Jury звезду на GitHub',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Design Jury запущен, и повторите попытку.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Design Jury — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с Design Jury — загрузка не нужна.',
  ...
  'updater.availableBody': 'Design Jury {version} доступен. Он будет загружен перед открытием установщика.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. Design Jury закрывается, чтобы вы могли завершить обновление.',
  ...
  'updater.quitButton': 'Закрыть Design Jury',
  'updater.quitFailedBody': 'Установщик открыт, но Design Jury не удалось закрыть. Закройте Design Jury перед заменой приложения.',
  'updater.quitFailedTitle': 'Не удалось закрыть',
  'updater.quitting': 'Закрытие...',
  'updater.ready': 'Обновление готово',
  'updater.readyGeneric': 'Новая версия готова. Design Jury закроется и откроет установщик.',
  'updater.readyVersion': 'Design Jury {version} готов. Design Jury закроется и откроет установщик.',
