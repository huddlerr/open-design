...
export const pl: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon Design Jury (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do Design Jury.',
  ...
  'settings.mcpServerHint': 'Udostępnij Design Jury jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj Design Jury gwiazdkę na GitHubie',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że Design Jury jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do Design Jury — wybierz jednego i adoptuj.',
  ...
  'pet.codexBundledTitle': 'Dostarczany z Design Jury — bez pobierania.',
  ...
  'updater.availableBody': 'Design Jury {version} jest dostępny. Zostanie pobrany przed otwarciem instalatora.',
  ...
  'updater.installerOpenBody': 'Instalator jest otwarty. Design Jury zamyka się, aby można było dokończyć aktualizację.',
  ...
  'updater.quitButton': 'Zamknij Design Jury',
  'updater.quitFailedBody': 'Instalator jest otwarty, ale nie można zamknąć Design Jury. Zamknij Design Jury przed zastąpieniem aplikacji.',
  'updater.quitFailedTitle': 'Nie można zamknąć',
  'updater.quitting': 'Zamykanie...',
  'updater.ready': 'Aktualizacja gotowa',
  'updater.readyGeneric': 'Nowa wersja jest gotowa. Design Jury zamknie się i otworzy instalator.',
  'updater.readyVersion': 'Design Jury {version} jest gotowy. Design Jury zamknie się i otworzy instalator.',
