...
export const ja: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'npm または Homebrew で CLI をインストールしたのに未インストールのまま表示される場合は、Design Jury daemon が引き継ぐ PATH にツールの bin ディレクトリが含まれていることを確認してください（macOS では Terminal と GUI アプリで PATH が異なる場合があります）。QUICKSTART.md（"Local agent CLI and PATH" セクション）を参照してください。',
  'settings.agentInstall.stepOpenLinks': '利用したいエージェントの「インストール」または「ドキュメント」を開きます。',
  'settings.agentInstall.stepAuth':
    'Design Jury に戻る前に、ベンダー CLI で認証（サインインまたは API 資格情報の追加）を行います。',
  ...
  'settings.mcpServerHint': 'Design Jury を MCP サーバーとしてコーディングエージェントに公開します。',
  ...
  'entry.githubStarAria': 'GitHub で Design Jury にスターを付ける',
  ...
  'preview.errorBody': '例の HTML を取得できませんでした。Design Jury が起動していることを確認して再試行してください。',
  'preview.retry': '再試行',
  ...
  'pet.title': 'ペット',
  'pet.tabBuiltIn': '組み込み',
  'pet.tabBuiltInHint': 'Design Jury に同梱された厳選コンパニオン — 選んで迎え入れよう。',
  ...
  'pet.codexBundled': '同梱',
  'pet.codexBundledTitle': 'Design Jury に同梱 — ダウンロード不要。',
  ...
  'updater.availableBody': 'Design Jury {version} を利用できます。インストーラーを開く前にダウンロードします。',
  ...
  'updater.installerOpenBody': 'インストーラーが開いています。更新を完了できるよう Design Jury を終了しています。',
  ...
  'updater.quitButton': 'Design Jury を終了',
  'updater.quitFailedBody': 'インストーラーは開いていますが、Design Jury を終了できませんでした。アプリを置き換える前に Design Jury を終了してください。',
  'updater.quitFailedTitle': '終了できませんでした',
  'updater.quitting': '終了しています...',
  'updater.ready': 'アップデート準備完了',
  'updater.readyGeneric': '新しいバージョンの準備ができました。Design Jury を閉じてインストーラーを開きます。',
  'updater.readyVersion': 'Design Jury {version} の準備ができました。Design Jury を閉じてインストーラーを開きます。',
