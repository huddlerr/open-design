...
export const it: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Design Jury (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Design Jury.',
  ...
  'settings.mcpServerHint': 'Esponi Design Jury come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Design Jury',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Design Jury',
  'settings.privacyConsentLead': 'Design Jury può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Design Jury sia in esecuzione e riprova.',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Design Jury — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Design Jury — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'Design Jury v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'Design Jury {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. Design Jury si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.quitButton': 'Esci da Design Jury',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma Design Jury non è riuscito a uscire. Esci da Design Jury prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. Design Jury si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'Design Jury {version} è pronto. Design Jury si chiuderà e aprirà il programma di installazione.',
