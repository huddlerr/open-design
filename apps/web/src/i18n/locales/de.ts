...
export const de: Dict = {
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu Design Jury zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle Design Jury als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': 'Design Jury auf GitHub einen Stern geben',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass Design Jury läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit Design Jury gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit Design Jury ausgeliefert — kein Download nötig.',
  ...
  'updater.availableBody': 'Design Jury {version} ist verfügbar. Es wird heruntergeladen, bevor der Installer geöffnet werden kann.',
  ...
  'updater.installerOpenBody': 'Der Installer ist geöffnet. Design Jury wird beendet, damit Sie das Update abschließen können.',
  ...
  'updater.quitButton': 'Design Jury beenden',
  'updater.quitFailedBody': 'Der Installer ist geöffnet, aber Design Jury konnte nicht beendet werden. Beenden Sie Design Jury, bevor Sie die App ersetzen.',
  'updater.quitFailedTitle': 'Beenden fehlgeschlagen',
  'updater.quitting': 'Wird beendet...',
  'updater.ready': 'Update bereit',
  'updater.readyGeneric': 'Eine neue Version ist bereit. Design Jury wird geschlossen und der Installer geöffnet.',
  'updater.readyVersion': 'Design Jury {version} ist bereit. Design Jury wird geschlossen und der Installer geöffnet.',
