...
export const uk: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon Design Jury (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до Design Jury.',
  ...
  'settings.mcpServerHint': 'Відкрийте Design Jury як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити Design Jury зірку на GitHub',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що Design Jury запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з Design Jury — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з Design Jury — завантаження не потрібне.',
  ...
  'updater.availableBody': 'Design Jury {version} доступний. Його буде завантажено перед відкриттям інсталятора.',
  ...
  'updater.installerOpenBody': 'Інсталятор відкрито. Design Jury закривається, щоб ви могли завершити оновлення.',
  ...
  'updater.quitButton': 'Закрити Design Jury',
  'updater.quitFailedBody': 'Інсталятор відкрито, але Design Jury не вдалося закрити. Закрийте Design Jury перед заміною застосунку.',
  'updater.quitFailedTitle': 'Не вдалося закрити',
  'updater.quitting': 'Закриття...',
  'updater.ready': 'Оновлення готове',
  'updater.readyGeneric': 'Нова версія готова. Design Jury закриється і відкриє інсталятор.',
  'updater.readyVersion': 'Design Jury {version} готовий. Design Jury закриється і відкриє інсталятор.',
