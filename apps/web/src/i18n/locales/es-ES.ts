...
export const esES: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de Design Jury (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a Design Jury.',
  ...
  'settings.mcpServerHint': 'Expón Design Jury como servidor MCP para tu agente de código.',
  ...
  'entry.githubStarAria': 'Dar una estrella a Design Jury en GitHub',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que Design Jury esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con Design Jury — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con Design Jury — sin descarga.',
  ...
  'updater.availableBody': 'Design Jury {version} está disponible. Se descargará antes de abrir el instalador.',
  ...
  'updater.installerOpenBody': 'El instalador está abierto. Design Jury se está cerrando para que puedas completar la actualización.',
  ...
  'updater.quitButton': 'Salir de Design Jury',
  'updater.quitFailedBody': 'El instalador está abierto, pero Design Jury no pudo cerrarse. Cierra Design Jury antes de reemplazar la app.',
  'updater.quitFailedTitle': 'No se pudo salir',
  'updater.quitting': 'Cerrando...',
  'updater.ready': 'Actualización lista',
  'updater.readyGeneric': 'Hay una nueva versión lista. Design Jury se cerrará y abrirá el instalador.',
  'updater.readyVersion': 'Design Jury {version} está listo. Design Jury se cerrará y abrirá el instalador.',
