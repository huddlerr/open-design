...
export const tr: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin Design Jury daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    'Design Jury\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'Design Jury\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': 'Design Jury\u2019a GitHub üzerinde yıldız ver',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Design Jury\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'Design Jury ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Design Jury ile birlikte gelir — indirme gerekmez.',
  ...
  'updater.availableBody': 'Design Jury {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için Design Jury kapatılıyor.',
  ...
  'updater.quitButton': 'Design Jury’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak Design Jury kapatılamadı. Uygulamayı değiştirmeden önce Design Jury’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. Design Jury kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'Design Jury {version} hazır. Design Jury kapanıp yükleyiciyi açacak.',
