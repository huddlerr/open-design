...
export const fa: Dict = {
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Design Jury، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Design Jury را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به Design Jury در GitHub ستاره بدهید',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Design Jury در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Design Jury — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Design Jury ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'updater.availableBody': 'Design Jury {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. Design Jury در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن Design Jury',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما Design Jury بسته نشد. پیش از جایگزینی برنامه، Design Jury را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. Design Jury بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'Design Jury {version} آماده است. Design Jury بسته می‌شود و نصب‌کننده را باز می‌کند.',
