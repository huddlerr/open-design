...
export const id: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon Design Jury (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke Design Jury.',
  ...
  'settings.mcpServerHint': 'Ekspos Design Jury sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star Design Jury di GitHub',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan Design Jury berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan Design Jury - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan Design Jury - tidak perlu diunduh.',
  ...
  'updater.availableBody': 'Design Jury {version} tersedia. Update akan diunduh sebelum installer dapat dibuka.',
  ...
  'updater.installerOpenBody': 'Installer sudah terbuka. Design Jury sedang ditutup agar Anda dapat menyelesaikan pembaruan.',
  ...
  'updater.quitButton': 'Tutup Design Jury',
  'updater.quitFailedBody': 'Installer sudah terbuka, tetapi Design Jury tidak dapat ditutup. Tutup Design Jury sebelum mengganti aplikasi.',
  'updater.quitFailedTitle': 'Tidak dapat menutup',
  'updater.quitting': 'Menutup...',
  'updater.ready': 'Update siap',
  'updater.readyGeneric': 'Versi baru siap. Design Jury akan ditutup dan membuka installer.',
  'updater.readyVersion': 'Design Jury {version} siap. Design Jury akan ditutup dan membuka installer.',
