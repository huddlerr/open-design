...
export const ptBR: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Design Jury (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Design Jury.',
  ...
  'settings.mcpServerHint': 'Exponha o Design Jury como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao Design Jury no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Design Jury está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Design Jury — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Design Jury — sem download.',
  ...
  'updater.availableBody': 'Design Jury {version} está disponível. Ela será baixada antes que o instalador possa abrir.',
  ...
  'updater.installerOpenBody': 'O instalador está aberto. O Design Jury está saindo para que você conclua a atualização.',
  ...
  'updater.quitButton': 'Sair do Design Jury',
  'updater.quitFailedBody': 'O instalador está aberto, mas não foi possível sair do Design Jury. Saia do Design Jury antes de substituir o app.',
  'updater.quitFailedTitle': 'Não foi possível sair',
  'updater.quitting': 'Saindo...',
  'updater.ready': 'Atualização pronta',
  'updater.readyGeneric': 'Uma nova versão está pronta. O Design Jury será fechado e abrirá o instalador.',
  'updater.readyVersion': 'Design Jury {version} está pronto. O Design Jury será fechado e abrirá o instalador.',
