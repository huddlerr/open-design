...
export const ko: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'npm 또는 Homebrew로 CLI를 설치했는데도 아직 미설치로 표시된다면, Design Jury daemon이 상속받는 PATH에 도구의 bin 디렉터리가 포함되어 있는지 확인하세요(macOS에서는 Terminal과 GUI 앱의 PATH가 다를 수 있습니다). QUICKSTART.md("Local agent CLI and PATH" 섹션)를 참고하세요.',
  'settings.agentInstall.stepOpenLinks': '원하는 에이전트 카드에서 설치 또는 문서 링크를 여세요.',
  'settings.agentInstall.stepAuth':
    'Design Jury으로 돌아오기 전에 공급자 CLI에서 인증(로그인 또는 API 자격 증명 추가)을 완료하세요.',
  ...
  'settings.mcpServerHint': 'Design Jury을 코딩 에이전트용 MCP 서버로 노출합니다.',
  ...
  'entry.githubStarAria': 'GitHub 에서 Design Jury 에 별 누르기',
  ...
  'preview.errorBody': '예제 HTML을 가져오지 못했습니다. Design Jury이 실행 중인지 확인하고 다시 시도하세요.',
  'preview.retry': '다시 시도',
  ...
  'pet.title': '펫',
  'pet.tabBuiltIn': '내장',
  'pet.tabBuiltInHint': 'Design Jury에 기본 포함된 친구들 — 골라서 입양하세요.',
  ...
  'pet.codexBundled': '내장',
  'pet.codexBundledTitle': 'Design Jury 에 내장 — 다운로드 불필요.',
  ...
  'updater.availableBody': 'Design Jury {version}을 사용할 수 있습니다. 설치 프로그램을 열기 전에 다운로드됩니다.',
  ...
  'updater.installerOpenBody': '설치 프로그램이 열려 있습니다. 업데이트를 완료할 수 있도록 Design Jury을 종료하는 중입니다.',
  ...
  'updater.quitButton': 'Design Jury 종료',
  'updater.quitFailedBody': '설치 프로그램이 열려 있지만 Design Jury을 종료할 수 없습니다. 앱을 교체하기 전에 Design Jury을 종료하세요.',
  'updater.quitFailedTitle': '종료할 수 없음',
  'updater.quitting': '종료 중...',
  'updater.ready': '업데이트 준비됨',
  'updater.readyGeneric': '새 버전이 준비되었습니다. Design Jury을 닫고 설치 프로그램을 엽니다.',
  'updater.readyVersion': 'Design Jury {version}이 준비되었습니다. Design Jury을 닫고 설치 프로그램을 엽니다.',
