...
export const zhTW: Dict = {
  ...
  'settings.onboardingCreateBody':
    '描述你想做的網站、應用、Deck、圖片或影片，Design Jury 會建立專案，並保留可繼續編輯的產出。',
  ...
  'settings.agentInstall.pathHint':
    '如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 Design Jury daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。',
  'settings.agentInstall.stepOpenLinks': '在目標代理卡片上開啟「安裝」或「文件」連結。',
  'settings.agentInstall.stepAuth':
    '返回 Design Jury 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。',
  ...
  'settings.mcpServerHint': '將 Design Jury 作為 MCP 伺服器暴露給你的編碼代理。',
  ...
  'settings.privacy': '隱私',
  'settings.privacyHint': '與 Design Jury 團隊共享哪些資料',
  'settings.privacyConsentKicker': '協助我們改進 Design Jury',
  'settings.privacyConsentLead': 'Design Jury 可以將使用資料分享給我們的團隊以協助改進。包含:',
  ...
  'settings.mcpHint':
    '讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 Design Jury 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。',
  'settings.mcpDaemonError':
    '無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 Design Jury 正在執行，然後重新開啟此面板。',
  'settings.mcpBuildDaemon': '請先建置守護行程。',
  'settings.mcpNodeMissing': '缺少 Node 執行檔。',
  'settings.mcpBuildHint':
    '缺少 apps/daemon/dist/cli.js。請執行 `pnpm --filter @design-jury/daemon build` 後重新整理。',
  ...
  'settings.mcpCapabilityDefault':
    '預設使用您在 Design Jury 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。',
  'settings.mcpRunningNote':
    'Design Jury 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 Design Jury 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。',
  ...
  'entry.githubStarAria': '在 GitHub 為 Design Jury 點亮 Star',
  ...
  'integrations.lede': '連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 Design Jury。',
  ...
  'mcpClient.daemonError': '無法連線到本機 daemon。請確認 Design Jury 正在執行，然後重新開啟此面板。',
  ...
  'preview.errorBody': '範例 HTML 載入失敗。請確認 Design Jury 正在執行後重試。',
  'preview.retry': '重試',
  ...
  'pet.title': '寵物',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'Design Jury 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'Design Jury 內建寵物，無需下載。',
  ...
  'settings.memoryStarterProjectDesc': 'Design Jury v0.5 — 聊天驅動的設計編輯器',
  ...
  'updater.availableBody': 'Design Jury {version} 可用。下載完成後即可開啟安裝器。',
  ...
  'updater.done': '完成',
  'updater.failed': '更新失敗',
  'updater.installerOpenBody': '安裝器已開啟。Design Jury 正在結束，以便你完成更新。',
  'updater.installerOpened': '安裝器已開啟',
  'updater.later': '稍後',
  'updater.openFailedFallback': '無法開啟安裝器。',
  'updater.openInstaller': '安裝更新',
  'updater.opening': '正在開啟安裝器…',
  'updater.quitButton': '結束 Design Jury',
  'updater.quitFailedBody': '安裝器已開啟，但 Design Jury 無法結束。替換應用程式前請先結束 Design Jury。',
  'updater.quitFailedTitle': '無法結束',
  'updater.quitting': '正在結束…',
  'updater.ready': '更新已就緒',
  'updater.readyGeneric': '新版本已就緒。Design Jury 會關閉並開啟安裝器。',
  'updater.readyVersion': 'Design Jury {version} 已就緒。Design Jury 會關閉並開啟安裝器。',
  ...
  'pluginCard.contributeAria': '將 {title} 貢獻至 Design Jury',
  'pluginCard.contributeTitle': '透過 pull request 將外掛貢獻至 Design Jury',
