...
export const fr: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon Design Jury (le Terminal et les applications graphiques peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Documentation pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth':
    'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans Design Jury.',
  ...
  'settings.mcpServerHint': 'Exposez Design Jury comme serveur MCP pour votre agent de code.',
  ...
  'settings.privacyHint': 'Données partagées avec l’équipe Design Jury',
  'settings.privacyConsentKicker': 'Aidez-nous à améliorer Design Jury',
  'settings.privacyConsentLead': 'Design Jury peut partager des données d’utilisation avec notre équipe pour nous aider à améliorer le produit. Cela inclut :',
  ...
  'entry.githubStarAria': 'Mettre une étoile à Design Jury sur GitHub',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'Design Jury est en cours d\'exécution et réessayez.',
  ...
  'pet.tabBuiltInHint': 'Compagnons fournis avec Design Jury — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec Design Jury — aucun téléchargement nécessaire.',
  ...
  'settings.memoryStarterProjectDesc': 'Design Jury v0.5 — éditeur de design piloté par chat',
  ...
  'updater.availableBody': 'Design Jury {version} est disponible. Elle sera téléchargée avant l’ouverture du programme d’installation.',
  ...
  'updater.installerOpenBody': 'Le programme d’installation est ouvert. Design Jury est en train de quitter pour vous permettre de terminer la mise à jour.',
  ...
  'updater.quitButton': 'Quitter Design Jury',
  'updater.quitFailedBody': 'Le programme d’installation est ouvert, mais Design Jury n’a pas pu quitter. Quittez Design Jury avant de remplacer l’application.',
  'updater.quitFailedTitle': 'Impossible de quitter',
  'updater.quitting': 'Fermeture...',
  'updater.ready': 'Mise à jour prête',
  'updater.readyGeneric': 'Une nouvelle version est prête. Design Jury va se fermer et ouvrir le programme d’installation.',
  'updater.readyVersion': 'Design Jury {version} est prêt. Design Jury va se fermer et ouvrir le programme d’installation.',
  ...
  'settings.mcpHint':
    'Permet à un agent de code dans un autre dépôt (Claude Code, Cursor, VS Code, Antigravity, Zed, Windsurf) de lire vos projets Design Jury. Utilisez-le pour intégrer un design dans votre app sans exporter d’abord un zip.',
  'settings.mcpDaemonError':
    'Impossible de joindre le daemon local pour résoudre les chemins d’installation ({error}). Vérifiez qu’Design Jury fonctionne, puis rouvrez ce panneau.',
  ...
  'settings.mcpBuildHint':
    'apps/daemon/dist/cli.js est introuvable. Exécutez `pnpm --filter @design-jury/daemon build`, puis actualisez.',
  ...
  'settings.mcpCapabilityDefault':
    'Utiliser par défaut le projet et le fichier ouverts dans Design Jury, afin que vous puissiez dire « intègre ce design dans mon application » sans repréciser quel design.',
  'settings.mcpRunningNote':
    'Design Jury doit être lancé pour que les appels d’outils MCP réussissent. Si vous avez démarré votre agent de code avant d’ouvrir Design Jury, redémarrez l’agent pour qu’il puisse joindre le daemon actif.',
