...
export const hu: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az Design Jury daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az Design Juryhoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az Design Juryt MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az Design Jury projektet a GitHubon',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az Design Jury fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.tabBuiltInHint': 'Az Design Jurynal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az Design Jurygal érkezik — letöltés nem szükséges.',
  ...
  'updater.availableBody': 'Az Design Jury {version} elérhető. A telepítő megnyitása előtt letöltődik.',
  ...
  'updater.installerOpenBody': 'A telepítő meg van nyitva. Az Design Jury kilép, hogy befejezhesse a frissítést.',
  ...
  'updater.quitButton': 'Kilépés az Design Juryból',
  'updater.quitFailedBody': 'A telepítő meg van nyitva, de az Design Jury nem tudott kilépni. Az alkalmazás cseréje előtt lépjen ki az Design Juryból.',
  'updater.quitFailedTitle': 'Nem sikerült kilépni',
  'updater.quitting': 'Kilépés...',
  'updater.ready': 'Frissítés kész',
  'updater.readyGeneric': 'Elkészült az új verzió. Az Design Jury bezárul, és megnyitja a telepítőt.',
  'updater.readyVersion': 'Az Design Jury {version} elkészült. Az Design Jury bezárul, és megnyitja a telepítőt.',
