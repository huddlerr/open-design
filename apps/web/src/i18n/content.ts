...
const DE_SKILL_COPY: Record<string, LocalizedSkillCopy> = {
  ...
  'design-jury-landing-deck': {
    ...
    description:
      'Erstellt ein Single-File-Slide-Deck im Atelier-Zero-Stil (warmes Papier, italic-serif Akzent-Spans, korallenfarbene Schluss-Dots, surreale Collage-Platten). Horizontale Magazin-Pagination mit Pfeiltasten- und Leertaste-Navigation, Live-HUD mit Slide-Zähler und Fortschrittsbalken; teilt sich Stylesheet und 16-Slot-Bildbibliothek mit der Schwester-Skill `design-jury-landing`.',
  },
  'email-marketing': {
    examplePrompt:
