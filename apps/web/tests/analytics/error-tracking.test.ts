...
describe('error-tracking', () => {
  ...
  it('scrubs absolute filesystem paths from stack frames before dispatch', () => {
    ...
    error.stack = [
      'Error: scrub-target',
      '    at handleClick (file:///Applications/Design Jury.app/Contents/Resources/apps/web/src/FileViewer.tsx:147:23)',
    ...
    for (const frame of frames!) {
      ...
      if (typeof filename === 'string') {
        ...
        expect(filename).not.toContain('Applications/Design Jury.app');
