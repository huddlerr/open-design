...
>
> **Швидка ітерація на `main`** — 0.8.0 — наступна фаза Design Jury. Кидай PR, кидай шалену ідею, заводь баг — те, що приносиш ти, тим стає цей рух.
>
> → [**Прочитати анонс · завантажити інсталятор · приєднатися до руху**](https://github.com/nexu-io/design-jury/discussions/1727) · встановлюється паралельно з твоєю поточною 0.7.
...
<p align="center">
  <a href="https://design-jury.ai/"><img alt="Завантажити" src="https://img.shields.io/badge/%D0%B7%D0%B0%D0%B2%D0%B0%D0%BD%D1%82%D0%B0%D0%B6%D0%B8%D1%82%D0%B8-open--design.ai-ff6b35?style=flat-square" /></a>
...
| **Розгортувати до** | Локально (`pnpm tools-dev`) · Vercel web layer · спакований Electron desktop-додаток для macOS (Apple Silicon) і Windows (x64) — завантаження з [design-jury.ai](https://design-jury.ai/) або зі [сторінки останнього релізу](https://github.com/nexu-io/design-jury/releases) |
| **Ліцензія** | Apache-2.0 |
...
└──────────────┬───────────────────────────────────┬───────────────┘
   ...
   │
   │  опціонально: sidecar IPC у /tmp/design-jury/ipc/<ns>/<app>.sock
...
Найшвидший спосіб спробувати Design Jury — готовий desktop-додаток, без Node, pnpm і клонування:

- **[design-jury.ai](https://design-jury.ai/)** — офіційна сторінка завантаження
- **[GitHub релізи](https://github.com/nexu-io/design-jury/releases)**
...
│   ├── sidecar-proto/             ← контракт протоколу sidecar Design Jury
...
- **Протокол sidecar + автоматизація desktop.** Процеси демона, вебу та desktop несуть типізовані п'ятипольні штампи (`app · mode · namespace · ipc · source`) та надають JSON-RPC IPC канал за адресою `/tmp/design-jury/ipc/<namespace>/<app>.sock`. `tools-dev inspect desktop status | eval | screenshot` керує цим каналом, тому headless E2E працює проти реальної Electron shell без спеціальних харнесів ([`packages/sidecar-proto/`](packages/sidecar-proto/), [`apps/desktop/src/main/`](apps/desktop/src/main/)).
...
| Вісь | [Claude Design][cd] (Anthropic) | [Open CoDesign][ocod] | **Design Jury** |
|---|---|---|---|
...
- [x] Пакетна збірка Electron з `apps/packaged/` — завантаження для macOS (Apple Silicon) і Windows (x64) на [design-jury.ai](https://design-jury.ai/) та на [сторінці релізів GitHub](https://github.com/nexu-io/design-jury/releases)
...
<p align="center">
  <a href="https://github.com/nexu-io/design-jury"><img src="docs/assets/star-us.png" alt="Поставте зірку Design Jury на GitHub — github.com/nexu-io/design-jury" width="100%" /></a>
</p>

Якщо це зекономило вам тридцять хвилин — поставте ★. Зірки не сплачують оренду, але вони кажуть наступному дизайнеру, агенту та контриб'ютору, що цей експеримент вартий їхньої уваги. Один клік, три секунди, реальний сигнал: [github.com/nexu-io/design-jury](https://github.com/nexu-io/design-jury).
...
Дякуємо всім, хто допоміг просувати Design Jury — через код, документацію, зворотний зв'язок, нові навички, нові системи дизайну або навіть гостре питання. Кожен реальний внесок рахується, а стіна нижче — найпростіший спосіб сказати це вголос.

<a href="https://github.com/nexu-io/design-jury/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=nexu-io/design-jury&cache_bust=2026-05-23" alt="Контриб'ютори Design Jury" />
</a>

Якщо ви злили свій перший PR — ласкаво просимо. Мітка [`good-first-issue`/`help-wanted`](https://github.com/nexu-io/design-jury/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22%2C%22help+wanted%22) — це точка входу.

## Активність репозиторію

<picture>
  <img alt="Design Jury — метрики репозиторію" src="docs/assets/github-metrics.svg" />
</picture>
...
<a href="https://star-history.com/#nexu-io/design-jury&Date">
  <picture>
    ...
    <img alt="Історія зірок Design Jury" src="https://api.star-history.com/svg?repos=nexu-io/design-jury&type=Date&cache_bust=2026-05-23" />
  </picture>
</a>
